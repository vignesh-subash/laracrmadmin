 ...
 */
 class Module extends Model
 {
 	...
 	public static function generateBase($module_name, $icon) {
 		...
 		$names = LCAHelper::generateModuleNames($module_name,$icon);
 	...
 	public static function generate($module_name, $module_name_db, $view_col, $faIcon = "fa-cube", $fields) {
 		...
 		$names = LCAHelper::generateModuleNames($module_name, $faIcon);
 					...
 					case 'Checkbox':
 						...
 						case 'Date':
 							...
 							//	$d2 = date("d/m/Y",$date);
 								...
 								$request->{$field['colname']} = date("d-m-Y", strtotime($request->{$field['colname']}));
