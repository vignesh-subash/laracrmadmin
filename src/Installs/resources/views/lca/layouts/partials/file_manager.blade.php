				...
				<div class="row">
					<div class="col-xs-3 col-sm-3 col-md-3">
						<div class="fm_folder_selector">
							<form action="{{ url(config('laracrm.adminRoute') . '/upload_files')}}" id="fm_dropzone" enctype="multipart/form-data" method="POST">
								{{ csrf_field() }}
								...
								@if(!config('laracrm.uploads.private_uploads'))
									...
									{{ Form::checkbox("public", "public", config("laracrm.uploads.default_public"), []) }}
