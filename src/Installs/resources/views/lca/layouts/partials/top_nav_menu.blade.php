...
<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
	<ul class="nav navbar-nav">
		...
		@foreach ($menuItems as $menu)
			@if($menu->type == "module")
				...
				?>
				@lca_access($temp_module_obj->id)
					@if(isset($module->id) && $module->name == $menu->name)
						<?php echo LCAHelper::print_menu_topnav($menu ,true); ?>
					@else
						<?php echo LCAHelper::print_menu_topnav($menu); ?>
					@endif
				@endlca_access
			@else
				<?php echo LCAHelper::print_menu_topnav($menu); ?>
	...
	@if(LCAConfigs::getByKey('sidebar_search'))
