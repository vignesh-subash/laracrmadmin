<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif{{ LCAConfigs::getByKey('sitename') }}</title>
    ...
    -->
    <link href="{{ asset('la-assets/css/skins/'.LCAConfigs::getByKey('skin').'.css') }}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
