...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@lca_access("Roles", "edit")
				<a href="{{ url(config('laracrm.adminRoute') . '/roles/'.$role->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endlca_access

			@lca_access("Roles", "delete")
				{{ Form::open(['route' => [config('laracrm.adminRoute') . '.roles.destroy', $role->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laracrm.adminRoute') . '/roles') }}" data-toggle="tooltip" data-placement="right" title="Back to Roles"><i class="fa fa-chevron-left"></i></a></li>
	...
	<div class="tab-content">
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@lca_display($module, 'display_name')
						@lca_display($module, 'description')
						@lca_display($module, 'parent')
		...
		<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-access">
			...
			<form action="{{ url(config('laracrm.adminRoute') . '/save_module_role_permissions/'.$role->id) }}" method="post">
