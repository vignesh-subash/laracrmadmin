...
@section("section_url", url(config('laracrm.adminRoute') . '/modules/'.$module->id))
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($field, ['route' => [config('laracrm.adminRoute') . '.module_fields.update', $field->id ], 'method'=>'PUT', 'id' => 'field-edit-form']) !!}
                    ...
                    <br>
					<div class="form-group">
						{!! Form::submit( 'Update', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laracrm.adminRoute') . '/modules/'.$module->id) }}">Cancel</a></button>
					</div>
				{!! Form::close() !!}
