...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-3">
					<!--<img class="profile-image" src="{{ asset('lca-assets/img/avatar5.png') }}" alt="">-->
		...
		<div class="col-md-1 actions">
			@lca_access("Organizations", "edit")
				<a href="{{ url(config('laracrm.adminRoute') . '/organizations/'.$organization->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endlca_access

			@lca_access("Organizations", "delete")
				{{ Form::open(['route' => [config('laracrm.adminRoute') . '.organizations.destroy', $organization->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laracrm.adminRoute') . '/organizations') }}" data-toggle="tooltip" data-placement="right" title="Back to Organizations"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@lca_display($module, 'phone')
						@lca_display($module, 'website')
						@lca_display($module, 'assigned_to')
						@lca_display($module, 'connect_since')
						@lca_display($module, 'address')
						@lca_display($module, 'city')
						@lca_display($module, 'description')
						@lca_display($module, 'profile_image')
						@lca_display($module, 'profile')
					</div>
				</div>
			</div>
		</div>
