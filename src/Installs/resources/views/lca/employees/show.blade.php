...
<div id="page-content" class="profile2">
	<div class="bg-success clearfix">
		...
		<div class="col-md-1 actions">
			@lca_access("Employees", "edit")
				<a href="{{ url(config('laracrm.adminRoute') . '/employees/'.$employee->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endlca_access

			@lca_access("Employees", "delete")
				{{ Form::open(['route' => [config('laracrm.adminRoute') . '.employees.destroy', $employee->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laracrm.adminRoute') . '/employees') }}" data-toggle="tooltip" data-placement="right" title="Back to Employees"><i class="fa fa-chevron-left"></i></a></li>
	...
	<div class="tab-content">
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@lca_display($module, 'name')
						@lca_display($module, 'designation')
						@lca_display($module, 'gender')
						@lca_display($module, 'mobile')
						@lca_display($module, 'mobile2')
						@lca_display($module, 'email')
						@lca_display($module, 'dept')
						@lca_display($module, 'city')
						@lca_display($module, 'address')
						@lca_display($module, 'about')
						@lca_display($module, 'date_birth')
						@lca_display($module, 'date_hire')
						@lca_display($module, 'date_left')
						@lca_display($module, 'salary_cur')
					</div>
				</div>
			</div>
		</div>
		...
		<div role="tabpanel" class="tab-pane fade" id="tab-account-settings">
			<div class="tab-content">
				<form action="{{ url(config('laracrm.adminRoute') . '/change_password/'.$employee->id) }}" id="password-reset-form" class="general-form dashed-row white" method="post" accept-charset="utf-8">
					{{ csrf_field() }}
					<div class="panel">
						<div class="panel-default panel-heading">
