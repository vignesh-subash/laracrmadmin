<?php
/**
 * Controller genrated using LaraCRM
...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($type == "module") {
            ...
            return redirect(config('laracrm.adminRoute').'/lca_menus');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route(config('laracrm.adminRoute').'.lca_menus.index');
    }
